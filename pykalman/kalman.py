...
class Kalman:
    def __init__(self, x_hat, P, Q, R=None, f=None, h=None,
        ...
        :param R: the covariance matrix that represents the observation noise
                  This implementation assumes that R is a constant and that
                  the observation noise is zero-mean.
                  Passing R here is optional, it may be passed in the update
                  function if different types of measurements are required.
